            ...
            <form class="row g-3" id="user-reg" method="POST">
                ...
                <div class="col-md-12 mb-4">
                    <div class="mb-3">
                        ...
                        <label class="form-label" for="signature">Photo<span class="text-danger">*</span></label>

                        <main class="page">
                            <input type="file" id="file-input" required accept="image/*" class="form-control" name="signature">
